...
export const enum TileType {
  ...
  // New corner shapes for nicer edges
  CornerTL = 4, // '^'
  CornerTR = 5, // '>'
  CornerBR = 6, // 'v'
  CornerBL = 7, // '<'
...
// You can now also use: ^ > v < for corner tiles.
const raw = [
  '####################',
  '#S................>#',
  '##############<....#',
...
export const npcWaypoints: Waypoint[] = [
  ...
  { x: 18.5 * TILE_SIZE, y: 9.5 * TILE_SIZE }, // down right corridor
  { x: 16 * TILE_SIZE, y: 13 * TILE_SIZE }, // bottom-right bend
  { x: 11.5 * TILE_SIZE, y: 13.5 * TILE_SIZE }, // bottom straight-ish
  { x: 5 * TILE_SIZE, y: 13.5 * TILE_SIZE }, // bottom-left
  { x: 3.55 * TILE_SIZE, y: 11 * TILE_SIZE }, // bottom-left
  { x: 4.5 * TILE_SIZE, y: 9.5 * TILE_SIZE }, // up left side
  { x: 3 * TILE_SIZE, y: 4.5 * TILE_SIZE }, // mid-left
  { x: 4.5 * TILE_SIZE, y: 4 * TILE_SIZE }, // inner left
  { x: 12.5 * TILE_SIZE, y: 3.5 * TILE_SIZE }, // inner top
  { x: 13.5 * TILE_SIZE, y: 10.5 * TILE_SIZE }, // inner right-ish
  { x: 7.5 * TILE_SIZE, y: 11.5 * TILE_SIZE }, // inner bottom-ish
];
